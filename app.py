...
def login():
    if request.method == 'POST':
        ...
        if username == 'user' and password == 'password':
            ...
            flash(f'Welcome, to Forecast Dashboard!', 'success')
            ...
            if weather_data is not None:
                ...
                for region in selected_regions:
                    if hourly_predictions[region]:
                        ...
                        peak_hour_index = demands.index(peak_demand)
                        least_hour_index = demands.index(least_demand)

                        peak_hour = hourly_predictions[region][peak_hour_index]['hour']
                        least_hour = hourly_predictions[region][least_hour_index]['hour']
